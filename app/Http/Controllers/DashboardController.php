...
<a href='/shares/show/{$id}' class='btn btn-sm purple-bg white-font '><i class='feather icon-eye'></i></a>
<a href='/shares/edit/{$id}' class='btn btn-sm btn-info'><i class='feather icon-edit'></i></a>
<a href='/shares/delete/{$id}' class='btn btn-sm btn-danger'><i class='feather icon-trash'></i></a>
