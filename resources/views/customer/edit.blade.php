            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('customer.update',$customer->id)}}" class="needs-validation" novalidate>   @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                        ...
                                        <div class="col-form-label">
                                            <select class="form-control" name="package_id" id="package_id" aria-describedby="validationTooltipPackagePrepend" required>
                                                ...
                                                @foreach($packages as $package)
                                                    <option {{ $customer->package_id === $package->id ? "selected=selected" : '' }} value="{{ $package->id }}">{{ $package->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-form-label">
                                            <input type="text" class="form-control" value="{{ $customer->name }}" name="name" id="name" aria-describedby="validationTooltipUsernamePrepend" required />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-form-label">
                                            <input type="text" class="form-control" value="{{ $customer->username }}" name="username" id="username" aria-describedby="validationTooltipUsernamePrepend" required />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-form-label">
                                            <input type="text" class="form-control" value="{{ $customer->mobile }}" name="mobile" id="mobile" aria-describedby="validationTooltipUsernamePrepend" required />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-form-label">
                                            <textarea class="form-control" name="address" id="exampleFormControlTextarea1" rows="3" aria-describedby="validationTooltipUsernamePrepend" required >{{ $customer->address }}</textarea>
                                ...
                                <div class="col-sm-6">
                                            ...
                                            <select class="form-control" name="zone_id" id="zone_id" aria-describedby="validationTooltipPackagePrepend" required>
                                                ...
                                                @foreach($locations as $location)
                                                    @if('Zone' == $location->location_type)
                                                        <option {{ $customer->zone_id === $location->id ? "selected=selected" : '' }} value="{{ $location->id }}">{{ $location->name }}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                                            <div class="invalid-tooltip">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-form-label">
                                            <input type="date" class="form-control datePicker" value="{{ $customer->connectionDate }}" name="connectionDate" id="connectionDate" aria-describedby="validationTooltipUsernamePrepend" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-form-label" for="monthlyBill">Monthly Bill</label>
                                        <div class="col-form-label">
                                            <input type="text" class="form-control"  value="{{ $customer->monthlyBill }}" name="monthlyBill" id="monthlyBill"  />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-form-label" for="openingBalance">Opening Balance</label>
                                        <div class="col-form-label">
                                            <input type="text" class="form-control"  value="{{ $customer->openingBalance }}" name="openingBalance" id="openingBalance" />
                                        </div>
                                    </div>
                                </div>
                            </div>
