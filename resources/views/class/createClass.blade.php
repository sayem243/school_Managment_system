                ...
                <div class="card-block">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('class_store') }}" class="needs-validation" novalidate>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label" for="section">Section <span class="required">*</span></label>
                                <div class="col-sm-6 col-form-label">
                                    <input type="text" class="form-control" placeholder="Enter New Section Name" name="section" id="section" aria-describedby="validationTooltipUsernamePrepend" required />
                                    <div class="invalid-tooltip">
