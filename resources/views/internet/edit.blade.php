        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    @endif
                    <div class="card-body">
                        <form method="post" action="{{ route('internet.update',[$post->id]) }}" class="needs-validation" novalidate>
                            {{ method_field('PUT') }}
                            <div class="form-group row">
                                @csrf
                                <label class="col-sm-3 col-form-label" for="name">Package Name <span class="required">*</span></label>
                                <div class="col-sm-6 col-form-label">
                                    <input type="text" class="form-control" name="name" id="name" aria-describedby="validationTooltipUsernamePrepend" value="{{ isset($post) ? $post->name : '' }}" required />
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label" for="mobile">Package Amount <span class="required">*</span></label>
                                <div class="col-sm-6 col-form-label">
                                    <input type="text" class="form-control" name="price" id="price" aria-describedby="validationTooltipUsernamePrepend" value="{{ isset($post) ? $post->price : '' }}" required />
                                    <div class="invalid-tooltip">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 col-form-label">
                                    <input type="text" class="form-control" placeholder="Enter internet package youtube speed" name="youtube" id="youtube" value="{{ isset($post) ? $post->youtube : '' }}"  />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label" for="bdix">BDIX</label>
                                <div class="col-sm-6 col-form-label">
                                    <input type="text" class="form-control" name="bdix" id="bdix" placeholder="Enter internet package BDIX speed" value="{{ isset($post) ? $post->bdix : '' }}"  />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label" for="akamai">AKAMAI</label>
                                <div class="col-sm-6 col-form-label">
                                    <input type="text" class="form-control" name="akamai" id="akamai" placeholder="Enter internet package AKAMAI speed" value="{{ isset($post) ? $post->akamai : '' }}"  />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label" for="facebook">FACEBOOK</label>
                                <div class="col-sm-6 col-form-label">
                                    <input type="text" class="form-control" name="facebook" id="facebook" placeholder="Enter internet package facebook speed" value="{{ isset($post) ? $post->facebook : '' }}"  />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label" for="ftp">FTP</label>
                                <div class="col-sm-6 col-form-label">
                                    <input type="text" class="form-control" name="ftp" id="ftp" placeholder="Enter internet package FTP speed" value="{{ isset($post) ? $post->ftp : '' }}"  />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label" for="internet">INTERNET</label>
                                <div class="col-sm-6 col-form-label">
                                    <input type="text" class="form-control" name="internet" id="internet" placeholder="Enter internet package internet speed" value="{{ isset($post) ? $post->internet : '' }}"  />
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label" for="address">Description</label>
